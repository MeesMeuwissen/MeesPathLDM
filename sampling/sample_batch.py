...
submit_batch_job(
    ...
    gpus=0,
    location='remote',
    model= "s3://aiosyn-data-eu-west-1-bucket-ops/models/generation/logs/03-15-remote-GEN-331/checkpoints/epoch=9-step=22730.ckpt",
    summary="A PAS stained slide of a piece of kidney tissue",
    depth_of_sampling = 50,
    number=3000, #How many imgs to generate
